...
class InverterDriver {
    constructor(config) {
        ...
        this.capacityAh = 95; // Ємність з твого фото
    ...
    async fetchTelemetry() {
        if (this.mode === 'mock') {
            ...
            return {
                ...
                timestamp: new Date(),
                // Додаємо корисний розрахунок: на скільки годин вистачить
                remaining_time: ((this.capacityAh * this.voltage * (this.soc / 100)) / load_power).toFixed(1)
            };
        }
    }
